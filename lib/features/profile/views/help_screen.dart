            ...
            children: [
              ...
              ListTile(
                ...
                leading: Container(
                  ...
                  child: Icon(Icons.phone_outlined, color: Color(0xFFFF3B1F)),
                ),
                title: Text(
                  'Call Support',
              ...
              ListTile(
                ...
                onTap: () async {
                  final Uri emailUri = Uri(
                    ...
                    queryParameters: {'subject': 'Food Delivery Support'},
                  );
        ...
        child: Column(
          ...
          children: [
            ...
            GetBuilder<HelpController>(
              builder: (controller) {
                return Column(
                  children: List.generate(controller.helpItems.length, (index) {
              ...
              child: Column(
                children: [
                  Container(
                    ...
                    height: 52,
                    decoration: BoxDecoration(
                      color: const Color(0xFFFF3B1F).withValues(alpha: 0.10),
